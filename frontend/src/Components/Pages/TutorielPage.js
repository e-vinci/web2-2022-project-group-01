...
const TutorielPage = () => {
    ...
    div21.innerHTML = `If you are logged in, you can play ranked games which will be saved in your profile. Or you can simply play Quick game if you don’t want to create an account but those won’t be saved.`
